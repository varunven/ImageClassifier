...
def download_image(imageName, imageLink, type1, type2, test):
    type1directory = "C:\\Users\\dswhi\\.vscode\\Pokemon Image Creator\\MyScrapedImages\\type1\\train\\" + type1 + "\\"
    if test:
        type1directory = "C:\\Users\\dswhi\\.vscode\\Pokemon Image Creator\\MyScrapedImages\\type1\\test\\" + type1 + "\\"
    ...
    with open(newImageName, 'wb') as fd:
        for chunk in rawImage.iter_content(chunk_size=1024):
            fd.write(chunk)
    if type2 != "None":
        type2directory = "C:\\Users\\dswhi\\.vscode\\Pokemon Image Creator\\MyScrapedImages\\type2\\train\\" + type2 + "\\"
        if test:
            type2directory = "C:\\Users\\dswhi\\.vscode\\Pokemon Image Creator\\MyScrapedImages\\type2\\test\\" + type2 + "\\"
...
def main():
    ...
    df2 = pd.read_csv(r'C:\Users\dswhi\.vscode\Pokemon Image Creator\pokemon_3d_with_types.csv', encoding='latin-1')
